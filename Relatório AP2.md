...
A cena começa com um ambiente mais vazio e frio, representando a parte mais difícil do luto, e termina com um ambiente mais iluminado e acolhedor, simbolizando que o personagem está pronto para seguir em frente.

## Cenário e Iluminação
- **Primeira parte da cena:**  
  - Pouca decoração, ambiente vazio.  
  - Luz azulada para passar tristeza, solidão e sensação de vazio.

- **Transição pela ponte:**  
  - A ponte e o rio servem como metáforas para a mudança de fase na vida do personagem.  
  - Ele passa de um lado escuro para o lado mais iluminado.

- **Segunda parte da cena:**  
  - Iluminação alaranjada, como um pôr do sol.  
  - Representa aceitação e um novo começo.  
